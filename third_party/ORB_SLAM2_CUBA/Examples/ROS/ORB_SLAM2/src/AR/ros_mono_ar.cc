...
ORB_SLAM2_CUBA::ViewerAR viewerAR;
bool bRGB = true;
...
{
public:
    ImageGrabber(ORB_SLAM2_CUBA::System* pSLAM):mpSLAM(pSLAM){}

    void GrabImage(const sensor_msgs::ImageConstPtr& msg);

    ORB_SLAM2_CUBA::System* mpSLAM;
};
...
int main(int argc, char **argv)
{
    ...
    ORB_SLAM2_CUBA::System SLAM(argv[1],argv[2],ORB_SLAM2_CUBA::System::MONOCULAR,false);
    ...
    thread tViewer = thread(&ORB_SLAM2_CUBA::ViewerAR::Run,&viewerAR);
...
void ImageGrabber::GrabImage(const sensor_msgs::ImageConstPtr& msg)
{
    ...
    vector<ORB_SLAM2_CUBA::MapPoint*> vMPs = mpSLAM->GetTrackedMapPoints();
